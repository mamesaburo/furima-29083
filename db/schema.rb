...
ActiveRecord::Schema.define(version: 2020_12_19_034940) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchased_item_id"], name: "index_addresses_on_purchased_item_id"
  end
  ...
  add_foreign_key "addresses", "purchased_items"
